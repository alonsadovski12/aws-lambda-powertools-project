...
class FieldValidationClass:
    ...
    def __init__(self, **kwargs):
        ...
        self._check_mandatory_fields(fields, **kwargs)
...
# TODO: support opened as decimal type and not int
    ...
    def _init_cb_item_in_dynamodb(self):
        ...
        except ClientError: #TODO: change to specific exception - only if item does not exist:
